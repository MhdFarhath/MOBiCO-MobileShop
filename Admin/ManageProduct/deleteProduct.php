...
<body>
    ...
    <div class="card card-body">
        <form action="addproduct.html" method="post" enctype="multipart/form-data">
            ...
            <h4 class="card-header">What You are Deleting</h4><br>
            <div class="card-text">
    ...
    <!-- <nav aria-label="Page navigation example">
        ...
        <ul class="pagination">
            <li class="page-item"><a class="page-link" href="C:\Users\pcz\Desktop\project\update product.html">Previous</a></li>
