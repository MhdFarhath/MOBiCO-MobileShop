            ...
            <form  method="POST" enctype="multipart/form-data">
                ...
                <div class="card-text">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text"  name="STORAGE" class="form-control" id="quantity" >
                        </div>
                    </div>
                </div>
                <div class="card-text">
                ...
                <div class="card-text">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text"  name="DISPLAY" class="form-control" id="Display size" >
                        </div>
                    </div>
                </div>
                <div class="card-text">
                ...
                <div class="d-grid gap-2 col-6 mx-auto">
                    <input type="submit" class="btn btn-primary btn-sm " name="sumbit" value="Add Product">
                </div>
                ...
                //Save to Database 
	                ...
	                if ($error === 0) {
		                if ($img_size > 125000) {
                            ...
                            $query = "INSERT INTO product( PNAME, BNAME, CATEGORY, PRICE, STORAGE, CAMERA, DISPLAY, BATTERY, RAM, STOCK, PRODESC,PIC) VALUES  ('$PNAME','$BNAME','$CATEGORY','$PRICE', '$STORAGE','$CAMERA', '$DISPLAY', '$BATTERY', '$RAM', '$STOCK', '$PRODESC','$PIC')";
